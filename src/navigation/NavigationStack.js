    ...
    <NavigationContainer>
      <NavigationStack.Navigator
        screenOptions={({ navigation }) => ({
          ...
          headerRight: () => (
            <ShoppingCart onPressBtn={() => navigation.navigate('cart')} value={sumProductCountInBasket()} />
          ),
        })}>
        <NavigationStack.Screen name="home" component={Home} />
        <NavigationStack.Screen name="noteList" component={NoteListScreen} options={{ headerTitle: 'Note List' }} />
        <NavigationStack.Screen
          name="electronics"
          component={ElectronicsScreen}
          options={{ headerTitle: 'Electronics' }}
        />
        <NavigationStack.Screen name="cart" component={CartScreen} options={{ headerTitle: 'Cart' }} />
      </NavigationStack.Navigator>
    </NavigationContainer>
  );
};
